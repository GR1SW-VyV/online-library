...
Feature: Display notes
  ...
  Scenario Outline: Page notes
    ...
    * there are notes <page_notes> added by other users who are <user_type> with <followers> followers in the page <page_number> on <date> date marked as <is_favorite> favorite
    ...
    | ML Algorithms  | 3           | julia.chen    | professor,professor,professor | 7,8,9     | 2           | Too shallow,Good for beginners,Lacks real-world examples            | 2023-01-03,2023-01-01,2023-01-02 | 1,1,0       | Lacks real-world examples,Good for beginners,Too shallow            |
