...
Feature: Display notes
  ...
  Scenario Outline: Page notes
    ...
    * there are notes <page_notes> added by other users who are <user_type> with <followers> followers in the page <page_number> on <date> date marked as <is_favorite> favorite
    ...
    | OOP Design     | 2           | sarah.miller  | professor,professor,reader    | 5,6,7     | 8           | Advanced content,Unclear terminology,Great diagram                  | 2023-01-03,2023-01-01,2023-01-02 | 1,0,0       | Unclear terminology,Advanced content,Great diagram                  |
    ...
    | ML Algorithms  | 3           | julia.chen    | professor,professor,professor | 7,8,9     | 2           | Too shallow,Good for beginners,Lacks real-world examples            | 2023-01-03,2023-01-01,2023-01-02 | 1,1,0       | Lacks real-world examplesGood for beginners,Too shallow             |
    ...
    | OOP Design     | 2           | robert.lee    | reader,reader,professor       | 6,7,8     | 12          | Valuable insights,Repetitive content,Not necessary                  | 2023-01-03,2023-01-01,2023-01-02 | 1,0,1       | Not necessary,Repetitive content,Valuable insights                  |
